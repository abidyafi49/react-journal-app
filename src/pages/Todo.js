...
export default function Todos(){
    ...
    function saveTodoHandler(event){
      ...
      setMessage(''); //buat ilangin message
      ...
      }]) //spread operator penyelamat
      setActivity(''); //kosongin setActivity
    ...
    return (
      <div>
        ...
        <form onSubmit={saveTodoHandler}>
          <input type='text' value={activity} placeholder='Nama aktifitas' onChange={function(event){
